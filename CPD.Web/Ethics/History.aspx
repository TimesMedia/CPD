...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
        ...
        <asp:GridView ID="GridViewCurrent" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="ResultId" DataSourceID="ObjectDataSourceCurrent" Height="16px" Width="952px">
            <Columns>
           <asp:BoundField DataField="ResultId" ReadOnly="True"
            ...
            <asp:BoundField DataField="Points" HeaderText="Points" 
                SortExpression="Points" Visible="false" />
            </Columns>
        </asp:GridView>
    ...
    <asp:GridView ID="GridViewHistory" runat="server" AutoGenerateColumns="False" Width="922px"
        DataKeyNames="ResultId" DataSourceID="ObjectDataSourceHistory" AutoGenerateSelectButton="True" 
...
<%--<SelectedRowStyle BackColor="Red"></SelectedRowStyle>--%>
    ...
    <br/>
    <asp:ObjectDataSource ID="ObjectDataSourceCurrent" runat="server" 
        SelectMethod="GetCurrentTest" TypeName="CPD.Data.ResultData">
        <SelectParameters>
            <asp:SessionParameter Name="CustomerId" SessionField="CustomerId" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ObjectDataSourceHistory" runat="server" 
        SelectMethod="GetHistory" TypeName="CPD.Data.ResultData">
        <SelectParameters>
            <asp:SessionParameter Name="CustomerId" SessionField="CustomerId" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:Button ID="ButtonReissue" CssClass="button-generic" runat="server" 
        Text="Reissue a certificate for a passed module" Width="280px" 
